...
def Receipt():
    ...
    txtReceipt.insert(END, '\tAGRAWAL RESTAURANT\t\t\t\t\n')
    txtReceipt.insert(END, 'Receipt Ref:\t\t\t' + Receipt_Ref.get() + '\t' + DateofOrder.get() + '\n')
    txtReceipt.insert(END, 'Items\t\t' + "Quantity \t\tCost\n")
    if E_Bananajuice.get()!="0":
        txtReceipt.insert(END, 'Bananajuice:\t\t    ' +E_Bananajuice.get()+ '\t\t'+str(int(E_Bananajuice.get())*40)+'\n')
    if E_Grapejuice.get()!="0":
        txtReceipt.insert(END, 'Grapejuice:\t\t    ' + E_Grapejuice.get() + '\t\t'+str(int(E_Grapejuice.get())*50)+'\n')
    if E_Pineapple.get()!="0":
        txtReceipt.insert(END, 'Pineapple:\t\t    ' + E_Pineapple.get() + '\t\t'+str(int(E_Pineapple.get())*60)+'\n')
    if E_Apple.get()!='0':
        txtReceipt.insert(END, 'Apple:\t\t    ' + E_Apple.get()+'\t\t'+str(int(E_Apple.get())*60)+ '\n')
    if E_Promaganate.get()!="0":
        txtReceipt.insert(END, 'Promaganate:\t\t    ' + E_Promaganate.get()+'\t\t'+str(int(E_Promaganate.get())*50)+ '\n')
    if E_Sprite.get()!="0":
        txtReceipt.insert(END, 'Sprite:\t\t    ' + E_Sprite.get()+'\t\t'+str(int(E_Sprite.get())*30)+ '\n')
    if E_CocaCola.get()!="0":
        txtReceipt.insert(END, 'CocaCola:\t\t    ' + E_CocaCola.get()+'\t\t'+str(int(E_CocaCola.get())*30)+ '\n')
    if E_Milkshakes.get()!="0":
        txtReceipt.insert(END, 'Milkshakes:\t\t    ' + E_Milkshakes.get()+'\t\t'+str(int(E_Milkshakes.get())*90)+ '\n')
    if E_Vegbiryani.get()!="0":
        txtReceipt.insert(END, 'Veg-Biryani:\t\t    ' + E_Vegbiryani.get()+'\t\t'+str(int(E_Vegbiryani.get())*100)+ '\n')
    if E_Nonvegbiryani.get()!="0":
        txtReceipt.insert(END, 'Nonveg-Biryani:\t\t    ' + E_Nonvegbiryani.get()+'\t\t'+str(int(E_Nonvegbiryani.get())*180)+ '\n')
    if E_Vegmeals.get()!="0":
        txtReceipt.insert(END, 'Vegmeals:\t\t    ' + E_Vegmeals.get()+'\t\t'+str(int(E_Vegmeals.get())*120)+ '\n')
    if E_Chapathi.get()!="0":
        txtReceipt.insert(END, 'Chapathi:\t\t    ' + E_Chapathi.get()+'\t\t'+str(int(E_Chapathi.get())*40)+ '\n')
    if E_Manchuria.get()!="0":
        txtReceipt.insert(END, 'Manchuria:\t\t    ' + E_Manchuria.get()+'\t\t'+str(int(E_Manchuria.get())*70)+ '\n')
    if E_Noodels.get()!="0":
        txtReceipt.insert(END, 'Noodels:\t\t    '+ E_Noodels.get()+'\t\t'+str(int(E_Noodels.get())*80)+ '\n')
    if E_Friedrice.get()!="0":
        txtReceipt.insert(END, 'Friedrice:\t\t    ' + E_Friedrice.get()+'\t\t'+str(int(E_Friedrice.get())*80)+ '\n')
    if E_Frinchfries.get()!="0":
        txtReceipt.insert(END, 'Frinchfries:\t\t    ' + E_Frinchfries.get()+'\t\t'+str(int(E_Frinchfries.get())*110)+ '\n')
...
Promaganate = Checkbutton(Drinks_F, text='Pomegranate 50', variable=var5, onvalue=1, offvalue=0,font=('arial', 18, 'bold'),bg='orange', command=chk_Promaganate).grid(row=4, sticky=W)
...
Milkshakes = Checkbutton(Drinks_F,  text='Milkshakes    90', variable=var8, onvalue=1, offvalue=0, font=('arial', 18, 'bold'),bg='orange', command=chk_Milkshakes).grid(row=7, sticky=W)

##############################################Drink Entry###############################################################
txtBananajuice = Entry(Drinks_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Bananajuice)
txtBananajuice.grid(row=0, column=1)

txtGrapejuice = Entry(Drinks_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Grapejuice)
txtGrapejuice.grid(row=1, column=1)

txtPineapple = Entry(Drinks_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Pineapple)
txtPineapple.grid(row=2, column=1)

txtApple = Entry(Drinks_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Apple)
txtApple.grid(row=3, column=1)

txtPromaganate = Entry(Drinks_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Promaganate)
...
txtMilkshakes = Entry(Drinks_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Milkshakes)
txtMilkshakes.grid(row=7, column=1)

#############################################Foods######################################################################

Vegbiryani = Checkbutton(Food_F,   text="Veg-Biryani       100", variable=var9, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Vegbiryani).grid(row=0, sticky=W)
Nonvegbiyani = Checkbutton(Food_F, text="Nonveg-Biryani 180", variable=var10, onvalue=1, offvalue=0,font=('arial', 16, 'bold'), bg='orange', command=chk_Nonvegbiryani).grid(row=1, sticky=W)
...
################################################Entry Box For Cake##########################################################
txtVegbiryani = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED, textvariable=E_Vegbiryani)
txtVegbiryani.grid(row=0, column=1)

txtNonvegbiryani = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Nonvegbiryani)
txtNonvegbiryani.grid(row=1, column=1)

txtVegmeals = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Vegmeals)
txtVegmeals.grid(row=2, column=1)

txtChapathi = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Chapathi)
txtChapathi.grid(row=3, column=1)

txtManchuria = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Manchuria)
txtManchuria.grid(row=4, column=1)

txtNoodels = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Noodels)
txtNoodels.grid(row=5, column=1)

txtFriedrice = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Friedrice)
txtFriedrice.grid(row=6, column=1)

txtFrinchfries = Entry(Food_F, font=('arial', 16, 'bold'), bd=8, width=6, justify=LEFT, state=DISABLED,textvariable=E_Frinchfries)
txtFrinchfries.grid(row=7, column=1)

###########################################ToTal Cost################################################################################
lblCostofDrinks = Label(Cost_F, font=('arial', 14, 'bold'), text='Cost of Drinks\t', bg='orange', fg='black', justify=CENTER)
...
lblCostofFood = Label(Cost_F, font=('arial', 14, 'bold'), text='Cost of Foods  ', bg='orange', fg='black', justify=CENTER)
...
lblServiceCharge = Label(Cost_F, font=('arial', 14, 'bold'), text='Service Charge', bg='orange', fg='black', justify=CENTER)
...
lblPaidTax = Label(Cost_F, font=('arial', 14, 'bold'), text='\tPaid Tax', bg='orange', bd=7,fg='black', justify=CENTER)
lblPaidTax.grid(row=0, column=2, sticky=W)
txtPaidTax = Entry(Cost_F, bg='white', bd=7, font=('arial', 14, 'bold'), insertwidth=2, justify=RIGHT, textvariable=PaidTax)
txtPaidTax.grid(row=0, column=3)

lblSubTotal = Label(Cost_F, font=('arial', 14, 'bold'), text='\tSub Total', bg='orange', bd=7,fg='black', justify=CENTER)
...
lblTotalCost = Label(Cost_F, font=('arial', 14, 'bold'), text='\tTotal', bg='orange', bd=7, fg='black', justify=CENTER)
...
###########################################BUTTONS################################################################################
btnTotal = Button(Buttons_F, padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='Total',bg='orange', command=CostofItem).grid(row=0, column=0)
btnReceipt = Button(Buttons_F, padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='Receipt',bg='orange', command=Receipt).grid(row=0, column=1)
btnReset = Button(Buttons_F, padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='Reset',bg='orange', command=Reset).grid(row=0, column=2)
btnExit = Button(Buttons_F, padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='Exit',bg='orange', command=iExit).grid(row=0, column=3)
